...
- [Stage 1 — Data acquisition + language filtering](#stage-1--data-acquisition--language-filtering)
- [Stage 2 — Text cleaning & normalisation](#stage-2--text-cleaning--normalisation)
- [Stage 3 — Safety filtering (PII & toxicity)](#stage-3--safety-filtering-pii--toxicity)
- [Stage 4 — Deduplication](#stage-4--deduplication)
- [Stage 5 — Tokenisation](#stage-5--tokenisation)
- [Stage 5.1 — Compute perplexity](#stage-51--compute-perplexity)
- [Stage 6 — Inspectability & Visualization Analysis](#stage-6--inspectability--visualization-analysis)
- [Stage 7 — Conceptual plan for scaling](#stage-7--conceptual-plan-for-scaling)
- [Final Section — Main Takeaways of Performance](#final-section--main-takeaways-of-performance)
- [Appendix — Visualization Insights](#appendix--visualization-insights)
